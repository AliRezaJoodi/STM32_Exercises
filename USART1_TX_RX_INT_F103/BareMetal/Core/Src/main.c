...
int main(void)
{
  ...
  */
  ...
  /* USER CODE BEGIN 2 */
	...
	AJ_USART_ConfigWordLength(USART1, AJ_USART_CR1_WORDLENGTH_8B);
	AJ_USART_ConfigParity(USART1, AJ_USART_CR1_PARITY_NONE);
	AJ_USART_ConfigStopBitsLength(USART1, AJ_USART_CR2_STOPBITS_1);
	...
	AJ_USART_ConfigBaudRate_16x(USART1, 8000000U, 9600U);
