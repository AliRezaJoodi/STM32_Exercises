...
/*
RTOFF: 	RTC operation OFF, Read only
...
__STATIC_INLINE void RTC_SynchronizedFlag_ResetFlag(void){
...
OWF: 	Overflow flag
			...
			It can be cleared only by software. Writing ‘1’ has no effect.
...
__STATIC_INLINE void RTC_OverflowFlag_ResetFlag(void){
...
__STATIC_INLINE void RTC_AlarmFlag_ResetFlag(void){
...
__STATIC_INLINE void RTC_SecondFlag_ResetFlag(void){
